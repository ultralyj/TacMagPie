 ...
 */
#ifndef __MLX90393_DEFS_H__
#define __MLX90393_DEFS_H__
 ...
 */
typedef enum {
    MLX90393_REG_00H = 0x00,
    MLX90393_REG_01H = 0x01,
    MLX90393_REG_02H = 0x02,
    MLX90393_REG_03H = 0x03,
    MLX90393_REG_04H = 0x04,
    MLX90393_REG_05H = 0x05,
    MLX90393_REG_06H = 0x06,
    MLX90393_REG_07H = 0x07,
    MLX90393_REG_08H = 0x08,
    MLX90393_REG_09H = 0x09,
    MLX90393_REG_MAX = 0xFF
} mlx90393_reg_t;
 ...
 */
typedef enum {
    MLX90393_METRIC_ALL_BITMASK = 0x8 | 0x4 | 0x2 | 0x1,
    MLX90393_METRIC_Z_AXIS_BITMASK = 0x8,
    MLX90393_METRIC_Y_AXIS_BITMASK = 0x4,
    MLX90393_METRIC_X_AXIS_BITMASK = 0x2,
    MLX90393_METRIC_TEMPERATURE_BITMASK = 0x1,
} mlx90393_metric_t;
 ...
 *
 */
typedef uint8_t mlx90393_status_byte_t;
...
typedef enum {
     ...
     */
    MLX90393_STATUS_BURST_MODE_BITMASK = 0x80,
    MLX90393_STATUS_WAKE_ON_CHANGE_MODE_BITMASK = 0x40,
    MLX90393_STATUS_SINGLE_MEASUREMENT_MODE_BITMASK = 0x20,
     ...
     *
     */
    MLX90393_STATUS_ERROR_BITMASK = 0x10,
     ...
     */
    MLX90393_STATUS_SED_BITMASK = 0x08,
     ...
     * */
    MLX90393_STATUS_RESET_BITMASK = 0x04,
     ...
     */
    MLX90393_STATUS_D1_BITMASK = 0x02,
    MLX90393_STATUS_D0_BITMASK = 0x01,
} mlx90393_status_bit_t;
 ...
 */
enum {
    MLX90393_HALLCONF_REG = 0x00,
    MLX90393_HALLCONF_BITMASK = 0x000F,
    MLX90393_HALLCONF_BITSHIFT = 0
};
typedef enum {
    MLX90393_HALLCONF_0 = 0x0, /*!< 0x0 is not supported (it is never used in reality). Always use HallConf=0xC */
    MLX90393_HALLCONF_C = 0xC, /*!< DEFAULT */
} mlx90393_hallconf_t;
 ...
 */
enum {
    MLX90393_GAIN_SEL_REG = 0x00,
    MLX90393_GAIN_SEL_BITMASK = 0x0070,
    MLX90393_GAIN_SEL_BITSHIFT = 4
};
typedef enum {
    MLX90393_GAIN_SEL_0 = 0, /*!<  */
    MLX90393_GAIN_SEL_1 = 1, /*!< */
    MLX90393_GAIN_SEL_2, /*!< */
    MLX90393_GAIN_SEL_3, /*!< */
    MLX90393_GAIN_SEL_4, /*!< */
    MLX90393_GAIN_SEL_5, /*!< */
    MLX90393_GAIN_SEL_6, /*!< */
    MLX90393_GAIN_SEL_7, /*!< DEFAULT */
    MLX90393_GAIN_SEL_MAX, /*!< Used to create static arrays */
} mlx90393_gain_sel_t;
 ...
 */
enum {
    MLX90393_Z_SERIES_REG = 0x00,
    MLX90393_Z_SERIES_BITMASK = 0x0080,
    MLX90393_Z_SERIES_BITSHIFT = 7
};
typedef enum {
    MLX90393_Z_SERIES_DISABLED = 0, /*!< */
    MLX90393_Z_SERIES_ENABLED = 1, /*!< */
} mlx90393_z_series_t;
 ...
 */
enum {
    MLX90393_BIST_REG = 0x00,
    MLX90393_BIST_BITMASK = 0x0100,
    MLX90393_BIST_BITSHIFT = 8
};
typedef enum {
    MLX90393_BIST_DISABLED = 0, /*!< */
    MLX90393_BIST_ENABLED = 1, /*!< */
} mlx90393_bist_t;
 ...
 */
enum {
    MLX90393_BURST_DATA_RATE_REG = 0x01,
    MLX90393_BURST_DATA_RATE_BITMASK = 0x003F,
    MLX90393_BURST_DATA_RATE_BITSHIFT = 0
};

enum {
    /* Not used yet because it belongs to the Burst Mode which is not implemented in this component */
    MLX90393_BURST_SEL_REG = 0x01,
    MLX90393_BURST_SEL_BITMASK = 0x03C0,
    MLX90393_BURST_SEL_BITSHIFT = 6
};
 ...
 */
enum {
    MLX90393_TCMP_EN_REG = 0x01,
    MLX90393_TCMP_EN_BITMASK = 0x0400,
    MLX90393_TCMP_EN_BITSHIFT = 10
};
typedef enum {
    MLX90393_TCMP_EN_DISABLED = 0, /*!< DEFAULT */
    MLX90393_TCMP_EN_ENABLED = 1, /*!< */
} mlx90393_tcmp_en_t;
 ...
 */
enum {
    MLX90393_EXT_TRIG_REG = 0x01,
    MLX90393_EXT_TRIG_BITMASK = 0x0800,
    MLX90393_EXT_TRIG_BITSHIFT = 11
};
typedef enum {
    MLX90393_EXT_TRIG_DISABLED = 0, /*!< */
    MLX90393_EXT_TRIG_ENABLED = 1, /*!< */
} mlx90393_ext_trig_t;
 ...
 */
enum {
    MLX90393_WOC_DIFF_REG = 0x01,
    MLX90393_WOC_DIFF_BITMASK = 0x1000,
    MLX90393_WOC_DIFF_BITSHIFT = 12
};

typedef enum {
    MLX90393_WOC_DIFF_ABSOLUTE_MODE = 0, /*!< If 0, an absolute mode is used. Measurements are compared to the first measurements; */
    MLX90393_WOC_DIFF_RELATIVE_MODE = 1, /*!< If 1, a relative mode is used. Measurements are compared to the previous ones. */
} mlx90393_woc_diff_t;
 ...
 */
enum {
    MLX90393_COMM_MODE_REG = 0x01,
    MLX90393_COMM_MODE_BITMASK = 0x6000,
    MLX90393_COMM_MODE_BITSHIFT = 13
};
typedef enum {
    MLX90393_COMM_MODE_I2C_AND_SPI = 0, /*!< DEFAULT */
    MLX90393_COMM_MODE_I2C_AND_SPI_1 = 1, /*!<  */
    MLX90393_COMM_MODE_SPI = 2, /*!<  */
    MLX90393_COMM_MODE_I2C = 3, /*!<  */
 ...
 *
 */enum {
    MLX90393_TRIG_INT_SEL_REG = 0x01,
    MLX90393_TRIG_INT_SEL_BITMASK = 0x8000,
    MLX90393_TRIG_INT_SEL_BITSHIFT = 15
};
typedef enum {
    MLX90393_TRIG_INT_SEL_DISABLED = 0, /*!< default */
    MLX90393_TRIG_INT_SEL_ENABLED = 1, /*!< */
} mlx90393_trig_int_sel_t;
 ...
 */
enum {
    MLX90393_OSR_REG = 0x02,
    MLX90393_OSR_BITMASK = 0x0003,
    MLX90393_OSR_BITSHIFT = 0
};
typedef enum {
    MLX90393_OSR_0 = 0, /*!< DEFAULT */
    MLX90393_OSR_1 = 1, /*!< */
    MLX90393_OSR_2, /*!< */
    MLX90393_OSR_3, /*!< */
} mlx90393_osr_t;
 ...
 *
 */enum {
    MLX90393_DIG_FILT_REG = 0x02,
    MLX90393_DIG_FILT_BITMASK = 0x001C,
    MLX90393_DIG_FILT_BITSHIFT = 2
};
typedef enum {
    MLX90393_DIG_FILT_0 = 0, /*!< DEFAULT */
    MLX90393_DIG_FILT_1 = 1, /*!< */
    MLX90393_DIG_FILT_2, /*!< */
    MLX90393_DIG_FILT_3, /*!< */
    MLX90393_DIG_FILT_4, /*!< */
    MLX90393_DIG_FILT_5, /*!< */
 ...
 *
 */enum {
    MLX90393_RES_XYZ_REG = 0x02,
    MLX90393_RES_XYZ_BITMASK = 0x07E0,
    MLX90393_RES_XYZ_BITSHIFT = 5
};
typedef enum {
    MLX90393_RES_XYZ_0 = 0, /*!< DEFAULT for X and Y and Z */
    MLX90393_RES_XYZ_1 = 1, /*!< */
    MLX90393_RES_XYZ_2, /*!< */
    MLX90393_RES_XYZ_3, /*!< */
    MLX90393_RES_XYZ_MAX, /*!< Used to create static arrays */
} mlx90393_res_xyz_t;
 ...
 */
enum {
    MLX90393_OSR2_REG = 0x02,
    MLX90393_OSR2_BITMASK = 0x1800,
    MLX90393_OSR2_BITSHIFT = 11
};
...
enum {
    ...
    MLX90393_SENS_TC_LT_REG = 0x03,
    MLX90393_SENS_TC_LT_BITMASK = 0x00FF,
    MLX90393_SENS_TC_LT_BITSHIFT = 0
};
...
enum {
    // These parameters are used for the temperature compensation for the sensitivity drift of the Hall elements.
    MLX90393_SENS_TC_HT_REG = 0x03,
    MLX90393_SENS_TC_HT_BITMASK = 0xFF00,
    MLX90393_SENS_TC_HT_BITSHIFT = 8
};
...
enum {
    ...
    MLX90393_OFFSET_X_REG = 0x04,
    MLX90393_OFFSET_X_BITMASK = 0xFFFF,
    MLX90393_OFFSET_X_BITSHIFT = 0
};
enum {
    /* 1 WORD. These parameters are used to compensate the offset in case the temperature compensation is enabled. They are not used with TCMP disabled. */
    MLX90393_OFFSET_Y_REG = 0x05,
    MLX90393_OFFSET_Y_BITMASK = 0xFFFF,
    MLX90393_OFFSET_Y_BITSHIFT = 0
};
enum {
    /* 1 WORD. These parameters are used to compensate the offset in case the temperature compensation is enabled. They are not used with TCMP disabled. */
    MLX90393_OFFSET_Z_REG = 0x06,
    MLX90393_OFFSET_Z_BITMASK = 0xFFFF,
    MLX90393_OFFSET_Z_BITSHIFT = 0
};
 ...
 */
enum {
    MLX90393_WOXY_THRESHOLD_REG = 0x07,
    MLX90393_WOXY_THRESHOLD_BITMASK = 0xFFFF,
    MLX90393_WOXY_THRESHOLD_BITSHIFT = 0
};
enum {
    MLX90393_WOZ_THRESHOLD_REG = 0x08,
    MLX90393_WOZ_THRESHOLD_BITMASK = 0xFFFF,
    MLX90393_WOZ_THRESHOLD_BITSHIFT = 0
};
enum {
    MLX90393_WOT_THRESHOLD_REG = 0x09,
    MLX90393_WOT_THRESHOLD_BITMASK = 0xFFFF,
    MLX90393_WOT_THRESHOLD_BITSHIFT = 0
};
/*
 * TREF
 *
...
enum {
     ...
     *
     */
    MLX90393_TREF_THRESHOLD_REG = 0x24,
    MLX90393_TREF_THRESHOLD_BITMASK = 0xFFFF,
    MLX90393_TREF_THRESHOLD_BITSHIFT = 0
};
